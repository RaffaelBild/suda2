...
import de.linearbits.suda2.SUDA2StatisticsAll;
...
public class Test10 extends AbstractTest{
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (String file : files) {
            ...
            System.out.println("New sets branch, without timing, with calculating scores per record");
            System.out.println("Dataset: " + file + " length: " + dataset.length);
            // Process
            int REPETITIONS = file.equals("data/test6.csv") ? 1 : 20;
//            REPETITIONS = 1;
            System.out.println("Repetitions: " + REPETITIONS);
            System.out.println("Timing on: " + Timeable.ENABLED);
            long time = System.nanoTime();
            for (int i=0; i<REPETITIONS; i++) {
//                long time2 = System.currentTimeMillis();
                SUDA2StatisticsAll stats = new SUDA2(dataset).getKeyStatisticsAndScores(0, true);
//                System.out.println(stats.getNumKeys());
