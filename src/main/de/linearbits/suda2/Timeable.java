...
//    public static long[][][]     typeMethodSizeTimeBuckets  = new long[TYPE_COUNT][TYPE_METHOD_COUNT][7];
    ...
    public static void printOverview() {
        ...
        printTypeMethodOverview("SupportRow", TYPE_INT_SET_HASH, TYPE_METHOD_SUPPORTROW);
        ...
        printTypeMethodOverview("SupportRow", TYPE_INT_SET_BITS, TYPE_METHOD_SUPPORTROW);
        ...
        printTypeMethodOverview("SupportRow", TYPE_INT_SET_SMALL, TYPE_METHOD_SUPPORTROW);
        System.out.println(" - HPPC");
        printTypeMethodOverview("Intersection", TYPE_INT_SET_HPPC, TYPE_METHOD_INTERSECTION);
        printTypeMethodOverview("SpecialRow", TYPE_INT_SET_HPPC, TYPE_METHOD_SPECIALROW);
        printTypeMethodOverview("SupportRow", TYPE_INT_SET_HPPC, TYPE_METHOD_SUPPORTROW);
    }
